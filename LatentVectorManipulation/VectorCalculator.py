...
def generate_images(Gs, seeds, names, subfolder, truncation_psi):
    ...
    for seed_idx, seed in enumerate(seeds):
        ...
        images = Gs.components.synthesis.run([seed], **Gs_kwargs)
...
def main():
    ...
    PerformVectorOperationAddSub("D:\PythonProjectsDDrive\MasterThesisClothesFittingwGANs\LatentSpaceImages\ToEditImages", avrgVecFront, avrgVecBack, Gs)
